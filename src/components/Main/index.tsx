          ...
          <div className="flex flex-col   items-center justify-center md:flex-row ">
            ...
            <div className="lg:w-7/12">
              <h1 className="mb-6 text-3xl font-medium ">
                Welcome to{' '}
                <span className="text-green-500">Rick and Morty</span> GraphQl
              </h1>
              <p className="px-2">
                Welcome to our GraphQL-powered website! This is the main page
                where you can explore the amazing world of the Rick and Morty
                API using GraphQL. Discover information about your favorite
                characters, episodes, and more. Get ready for an exciting
